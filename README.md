...
- 📝 **[SpecNote](https://github.com/TurnpikeWarrior/SpecNote)** - Notepad for AI Engineer    
...
- [Ghostty](https://github.com/ghostty-org/ghostty) + [herdr](https://herdr.dev/) / [tmux](https://github.com/tmux/tmux/wiki) 
